...
function [Ke,Fe,Me,Ve] = element_MassAndStiffness(k)
% Store the stiffness and mass matrices respectively in Ke, Me
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for n=1:N_GAUSS_POINT
    ...
    Ke = Ke + GAUSS_WEIGHT(n)*( GRAD'*GRAD )*detJ;
    Me = Me + GAUSS_WEIGHT(n)*( N'*N )*detJ;
