...
for n=1:N_GAUSS_POINT
    ...
    Ke(1:3,1:3) = Ke(1:3,1:3) + GAUSS_WEIGHT(n)*( rho*M*dphi_t/c*L'*GRAD )*r*Js;
    Fe(1:3) = Fe(1:3) + GAUSS_WEIGHT(n)*( -rho*L'*M*c + rho*M*dphi_n*(M-dphi_n/c)*L' )*r*Js;
end
